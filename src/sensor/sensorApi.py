...
def sensorPojo(data):
    pojoModel=['sensor_id','device_id','identification','sensor_name','sensor_type','unit','value_max','value_min','is_warn','sort']
    return crab.toList(pojoModel,data)

def sensorDataPojo(data):
    pojoModel=['sensor_id','device_id','identification','sensor_name','sensor_type','unit','value_max','value_min','is_warn','sort','monitor_id','sensor_id','value','create_time']
    return crab.toList(pojoModel,data)
